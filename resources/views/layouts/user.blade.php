...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('userlte/css/vendor.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('userlte/style.css') }}">
...
<body class="font-sans text-gray-900 antialiased">
        ...
        <div class="container py-2">
            <div class="row py-4 pb-0 pb-sm-4 align-items-center ">
                ...
                <div class="col-sm-4 col-lg-3 text-center text-sm-start">
                    <div class="main-logo">
                        <a href="/">
                            <img src="{{ asset('userlte/images/logo.png') }}" alt="logo" class="img-fluid">
                        </a>
                    </div>
                </div>
            ...
            <div class="swiper main-swiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide py-5">
                        <div class="row banner-content align-items-center">
                            <div class="img-wrapper col-md-5">
                                <img src="{{ asset('userlte/images/banner-img.png') }}" class="img-fluid">
                            </div>
                    ...
                    <div class="swiper-slide py-5">
                        <div class="row banner-content align-items-center">
                            <div class="img-wrapper col-md-5">
                                <img src="{{ asset('userlte/images//banner-img3.png') }}" class="img-fluid">
                            </div>
                            <div class="content-wrapper col-md-7 p-5 mb-5">
                                <div class="secondary-font text-primary text-uppercase mb-4">Save 10 - 20 % off</div>
                                <h2 class="banner-title display-1 fw-normal">Best destination for <span
                    ...
                    <div class="swiper-slide py-5">
                        <div class="row banner-content align-items-center">
                            <div class="img-wrapper col-md-5">
                                <img src="{{ asset('userlte/images/banner-img4.png') }}" class="img-fluid">
                            </div>
                            <div class="content-wrapper col-md-7 p-5 mb-5">
                                <div class="secondary-font text-primary text-uppercase mb-4">Save 10 - 20 % off</div>
                                <h2 class="banner-title display-1 fw-normal">Best destination for <span
        ...
        <div class="container pb-5">
            ...
            <div class="products-carousel swiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="card position-relative">
                            <a href="single-product.html"><img src="{{ asset('userlte/images/item1.jpg') }}"
              ...
              New
                        ...
                        <div class="card position-relative">
                            <a href="single-product.html"><img src="{{ asset('userlte/images/item2.jpg') }}"
                                    class="img-fluid rounded-4" alt="image"></a>
                            <div class="card-body p-0">
                                <a href="single-product.html">
                                    <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="card position-relative">
                            <a href="single-product.html"><img src="{{ asset('userlte/images/item3.jpg') }}"
                                    class="img-fluid rounded-4" alt="image"></a>
                            <div class="card-body p-0">
                                <a href="single-product.html">
                                    <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              ...
              New
                        ...
                        <div class="card position-relative">
                            <a href="single-product.html"><img src="{{ asset('userlte/images/item4.jpg') }}"
                                    class="img-fluid rounded-4" alt="image"></a>
                            <div class="card-body p-0">
                                <a href="single-product.html">
                                    <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              ...
              New
                        ...
                        <div class="card position-relative">
                            <a href="single-product.html"><img src="{{ asset('userlte/images/item7.jpg') }}"
                                    class="img-fluid rounded-4" alt="image"></a>
                            <div class="card-body p-0">
                                <a href="single-product.html">
                                    <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              ...
              New
                        ...
                        <div class="card position-relative">
                            <a href="single-product.html"><img src="{{ asset('userlte/images/item8.jpg') }}"
                                    class="img-fluid rounded-4" alt="image"></a>
                            <div class="card-body p-0">
                                <a href="single-product.html">
                                    <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
    ...
    <section id="foodies" class="my-5">
        <div class="container my-5 py-5">
            ...
            New
                    ...
                    <div class="card position-relative">
                        <a href="single-product.html"><img src="{{ asset('userlte/images/item9.jpg') }}"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-product.html">
                                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                ...
                <div class="item dog col-md-4 col-lg-3 my-4">
                    ...
                    <div class="card position-relative">
                        <a href="single-product.html"><img src="{{ asset('userlte/images/item10.jpg') }}"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-product.html">
                                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
            ...
            New
                    ...
                    <div class="card position-relative">
                        <a href="single-product.html"><img src="{{ asset('userlte/images/item11.jpg') }}"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-product.html">
                                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                ...
                <div class="item cat col-md-4 col-lg-3 my-4">
                    ...
                    <div class="card position-relative">
                        <a href="single-product.html"><img src="{{ asset('userlte/images/item12.jpg') }}"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-product.html">
                                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
            ...
            New
                    ...
                    <div class="card position-relative">
                        <a href="single-product.html"><img src="{{ asset('userlte/images/item13.jpg') }}"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-product.html">
                                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
            ...
            New
                    ...
                    <div class="card position-relative">
                        <a href="single-product.html"><img src="{{ asset('userlte/images/item14.jpg') }}"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-product.html">
                                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                ...
                <div class="item dog col-md-4 col-lg-3 my-4">
                    ...
                    <div class="card position-relative">
                        <a href="single-product.html"><img src="{{ asset('userlte/images/item15.jpg') }}"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-product.html">
                                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
            ...
            New
                    ...
                    <div class="card position-relative">
                        <a href="single-product.html"><img src="{{ asset('userlte/images/item16.jpg') }}"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-product.html">
                                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
        ...
        <div class="container">
            <div class="row flex-row-reverse banner-content align-items-center">
                <div class="img-wrapper col-12 col-md-6">
                    <img src="{{ asset('userlte/images/banner-img2.png') }}" class="img-fluid">
                </div>
        ...
        <div class="container py-5 mb-5">
            ...
            <div class=" swiper bestselling-swiper">
              ...
              New
                        ...
                        <div class="card position-relative">
                            <a href="single-product.html"><img src="{{ asset('userlte/images/item5.jpg') }}"
                                    class="img-fluid rounded-4" alt="image"></a>
                            <div class="card-body p-0">
                                <a href="single-product.html">
                                    <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              ...
              New
                        ...
                        <div class="card position-relative">
                            <a href="single-product.html"><img src="{{ asset('userlte/images/item6.jpg') }}"
                                    class="img-fluid rounded-4" alt="image"></a>
                            <div class="card-body p-0">
                                <a href="single-product.html">
                                    <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
    ...
    <section id="register" style="background: url('userlte/images/background-img.png') no-repeat;">
        <div class="container ">
        ...
        <div class="container py-5 my-5">
            ...
            <div class="row">
                <div class="col-md-4 my-4 my-md-0">
                    ...
                    <div class="card position-relative">
                        <a href="single-post.html"><img src="{{ asset('userlte/images/blog1.jpg') }}"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                ...
                <div class="col-md-4 my-4 my-md-0">
                    ...
                    <div class="card position-relative">
                        <a href="single-post.html"><img src="{{ asset('userlte/images/blog2.jpg') }}"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-post.html">
                ...
                <div class="col-md-4 my-4 my-md-0">
                    ...
                    <div class="card position-relative">
                        <a href="single-post.html"><img src="{{ asset('userlte/images/blog3.jpg') }}"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-post.html">
    ...
    <section id="insta" class="my-5">
        <div class="row g-0 py-5">
            <div class="col instagram-item  text-center position-relative">
                ...
                <a href="#">
                    <img src="{{ asset('userlte/images/insta1.jpg') }}" alt="insta-img"
            ...
            <div class="col instagram-item  text-center position-relative">
                ...
                <a href="#">
                    <img src="{{ asset('userlte/images/insta2.jpg') }}" alt="insta-img"
                        class="img-fluid rounded-3">
                </a>
            </div>
            <div class="col instagram-item  text-center position-relative">
                ...
                <a href="#">
                    <img src="{{ asset('userlte/images/insta3.jpg') }}" alt="insta-img"
                        class="img-fluid rounded-3">
                </a>
            </div>
            <div class="col instagram-item  text-center position-relative">
                ...
                <a href="#">
                    <img src="{{ asset('userlte/images/insta4.jpg') }}" alt="insta-img"
                        class="img-fluid rounded-3">
                </a>
            </div>
            <div class="col instagram-item  text-center position-relative">
                ...
                <a href="#">
                    <img src="{{ asset('userlte/images/insta5.jpg') }}" alt="insta-img"
                        class="img-fluid rounded-3">
                </a>
            </div>
            <div class="col instagram-item  text-center position-relative">
                ...
                <a href="#">
                    <img src="{{ asset('userlte/images/insta6.jpg') }}" alt="insta-img"
                        class="img-fluid rounded-3">
                </a>
            </div>
        </div>
    </section>
    @extends('includes.user.footer')
    ...
    <script src="{{ asset('userlte/js/jquery-1.11.0.min.js') }}"></script>
    <script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js"
        integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous">
    </script>
    <script src="{{ asset('userlte/js/plugins.js') }}"></script>
    <script src="{{ asset('userlte/js/script.js') }}"></script>
